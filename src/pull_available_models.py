...
MODEL_TO_NAME_MAPPING = {
    ...
    "@cf/mistral/mistral-7b-instruct-v0.1-vllm": "Misral 7B Instruct v0.1",
    "@cf/mistral/mistral-7b-instruct-v0.1": "Mistral 7B Instruct v0.1",
    "@cf/mistral/mistral-7b-instruct-v0.2-lora": "Misral 7B Instruct v0.2 (LoRA)",
    ...
    "@hf/google/gemma-7b-it": "Gemmma 7B Instruct",
    "@hf/meta-llama/meta-llama-3-8b-instruct": "Llama 3 8B Instruct",
    "@hf/mistral/mistral-7b-instruct-v0.2": "Misral 7B Instruct v0.2",
    ...
    "@hf/thebloke/mistral-7b-instruct-v0.1-awq": "Misral 7B Instruct v0.1 (AWQ)",
    ...
    "gemma-7b-it": "Gemmma 7B Instruct",
    ...
    "mistral-7b-instruct": "Misral 7B Instruct",
